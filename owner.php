...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="bgimage">
        <div class="menu">
          ...
          <div class="welcome">
            ...
            <div class="rightmenu">
              <button id="buttonone" <onclick="window.location.href='';">
                Logout
              </button>
          </div>
          </div>
    ...
    <div class="sidebar">
      ...
      <ul>
        <li>
          <a href="Post.php"><i class="fas fa-qrcode"></i>Dashboard</a>
        </li>
		<li>
          <a href="DeletePost.php"><i class="fas fa-link"></i>Create POST</a>
        </li>
        <li>
