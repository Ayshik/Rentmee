...
if(isset($_SESSION['loggedinuser']))
{
    ...
    $sql = "select * from homeseeker where username='$user_name'";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  if(isset($_POST['update']))
  {
    ...
    $sql1="update homeseeker set Name='$name' ,  email = '$email' , password = '$pass' , phone = '$phone' , Address = '$address' where username = '$user_name' ";
