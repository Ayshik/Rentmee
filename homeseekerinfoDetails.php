...
{
    $a = $_GET['sl'];
    $sql1 = "DELETE FROM homeseeker WHERE sl = '$a' ";

if (mysqli_query($con, $sql1)) {
  header("location:homeseekerinfo.php");
} else {
...
<section><div class="table-wrapper">
    <table class="fl-table">
        ...
        <?php
        $sl = $_GET['sl'];       
        $sql = "select * from homeseeker where sl = '$sl'";
       ...
       <tr><th>NATIONAL ID</th></tr>
       <tr><th><?php echo $row['nid'];?></th></tr>
       <tr><th>NAME</th></tr>
